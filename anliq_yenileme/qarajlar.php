<div id="qarajelaniucun" style="display: none;">
	<script type="text/javascript">
		
function MenzilHaqqindaKontrol() {
	...
	if (document.getElementById('Menzil_Elanlari_Ucun_Menzilin_Umumi_Sahesi_Id')) {
		...
		if (AvtoYusrusKmKontrol.value == "") {
			...
			if (document.getElementById('qaraj_elanlari_ucun_elan')) {
		var AvtoYusrusKmKontrol = document.getElementById('qaraj_elanlari_ucun_elan');
		if (AvtoYusrusKmKontrol.value == "") {
			document.getElementById('qaraj_elanlari_ucun_elan_metni').style.color = '#ff0000';
			document.getElementById('qaraj_elanlari_ucun_elan').style.color = '#ff0000';
			document.getElementById("qaraj_elanlari_ucun_elan").style.borderColor = "#ff0000";
			document.getElementById("qaraj_elanlari_ucun_elan").style.boxShadow = " 1px 0px 1px 0px #ff0000";
			document.getElementById("avtoelanhaqqindamelumat").removeAttribute("data-target");
			document.getElementById("avtodetayozellikietrafli").removeAttribute("data-target");
			document.getElementById("yenielansekil").removeAttribute("data-target");
			document.getElementById("yenielanunvan").removeAttribute("data-target");
...
<div class="form-group col-6">
	<label for="qaraj_elanlari_ucun_elan" id="qaraj_elanlari_ucun_elan_metni" ><span>*</span>Ünvan</label>
		<input type="text" tabindex="216" onkeydown="javascript: return event.keyCode == 69 ? false : true" name="unvan" required tabindex="9" class="form-control" id="qaraj_elanlari_ucun_elan" placeholder="Ünvan" oninput="MetinInputAlaniYazildi(this.id)"  onfocusout="MetinInputAlaniYazildi(this.id),SagVeSolBosluklariSIl(this.id)" maxlength = "100">
...
<div class="row check col-12">
	...
	<button class="btn btn-primary" tabindex="19" type="button" data-toggle="collapse" onclick="MenzilHaqqindaKontrol()" id="avtoelanhaqqindamelumat"
