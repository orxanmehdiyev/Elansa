...
<section>
	...
	<div id="ListelemeAlaniKapsayicisi">
		...
		if(isset($_REQUEST['siralama'])){
			...
			$dovletsaysor=$db->prepare("SELECT * FROM dovlet");
			$dovletsaysor->execute();
			...
			$dovletsor=$db->prepare("SELECT * FROM dovlet  order by $siralama LIMIT $SayfalamayaBaslanacakKayitSayisi, $DovletlerListelemeLimiti");
			$dovletsor->execute();
			?>
			<div class="ListelemeAlaniIciTabloAlaniKapsayicisi">
			<table class="ListelemeAlaniIciTablosu" align="center" cellpadding="0" cellspacing="0">
			<thead>
			<th class="KodSutunu"><a href="dovletler?siralama=<?php echo $id_sira ?>">Id</a></th>
			<th class="KodSutunu"><a href="dovletler?siralama=<?php echo $reqem_kodu ?>">Rəqəm <br> Kodu</a></th> 
			<th><a href="dovletler?siralama=<?php echo $adi ?>">Adı</a></th>
			<th><a href="dovletler?siralama=<?php echo $beynelxalq_adi ?>">Beynelxalq Adı</a></th>
			<th class="KodSutunu"><a href="dovletler?siralama=<?php echo $iso_kod_alfa_iki ?>">ISO KODU <br> ALFA 2</a></th>        
			<th class="KodSutunu"><a href="dovletler?siralama=<?php echo $iso_kod_alfa_uc ?>">ISO KODU <br> ALFA 3</a></th> 
			<th class="KodSutunu"><a href="dovletler?siralama=<?php echo $telefon_kodu ?>">Telefon <br> Kodu</a></th> 
			<th class="KodSutunu"><a href="dovletler?siralama=<?php echo $valyuta_kodu ?>">Valyuta <br> Kodu</a></th>
			<th class="KodSutunu"><a href="dovletler?siralama=<?php echo $musteqillik_tarixi ?>">Müstəqillik <br> Tarixi</a></th>
			...
			<?php echo $BulunanSayfaSayisi; ?> səyfədə, <?php echo $dovletsayi; ?> qeydiyatlı dövlət var. Göstərilən
