...
$Dovlet_Id = $_GET['Dovlet_Id'];
$dovletsor = $db->prepare("SELECT * FROM dovlet where SEO_URL=:SEO_URL and Dovlet_Id=:Dovlet_Id");
...
<section>
	<div id="seyfebaslikalani">
		...
		<span><?php echo $dovletcek['Dovlet_Ad']." Dövlətinin Yenilənməsi" ?></span>
		...
		<form id="DovletIslemleriFormu" name="DovletIslemleriFormu" action="Islem/dovlet_islem.php" method="POST">
			...
			<div class="SeyfeIciSetirAlaniKapsayici">
				<div class="SeyfeIciSetirAlaniKapsayiciYuzdeEllilikAlan">
					...
					<div class="SeyfeIciSetirAlanlariSagFormElementleriAlaniKapsayicisi">
						<input type="text" id="Dovlet_Ad" name="Dovlet_Ad" required="" value="<?php echo $dovletcek['Dovlet_Ad']?>"  class="FormAlanlariUcunTextInputlari" maxlength="100" tabindex="3" oninput="MetinInputAlaniYazildi(this.id)"  onfocusout="MetinInputAlaniYazildi(this.id),SagVeSolBosluklariSIl(this.id)">
					</div>
				</div>
			</div>
			...
			<div class="SeyfeIciSetirAlaniKapsayici">
				<div class="SeyfeIciSetirAlaniKapsayiciYuzdeEllilikAlan">
					...
					<div class="SeyfeIciSetirAlanlariSagFormElementleriAlaniKapsayicisi">
						<input type="text" id="Dovlet_Beynelxalq_Adi" name="Dovlet_Beynelxalq_Adi" value="<?php echo $dovletcek['Dovlet_Beynelxalq_Adi']?>"  onfocusout="MetinInputAlaniYazildi(this.id),SagVeSolBosluklariSIl(this.id)" oninput="MetinInputAlaniYazildi(this.id)" required="" class="FormAlanlariUcunTextInputlari" maxlength="100" tabindex="4" onKeyUp="AzerbaycanHerfleriniIngilisHerflereDeyisdir(this.id),IngilizceyeGoreKucukHarfBuyukHarfDegistir(this.id)">
					</div>
				</div>
			</div>
				...
				<div class="SeyfeIciSetirAlaniKapsayiciYuzdeEllilikAlan">
					...
					<div class="SeyfeIciSetirAlanlariSagFormElementleriAlaniKapsayicisi">
						<div class="YuzPixselSinirliAlanKapsayicisi">		
							<input type="text" id="ISO_KODU_ALFA_2" name="ISO_KODU_ALFA_2" value="<?php echo $dovletcek['ISO_KODU_ALFA_2']?>" onfocusout="MetinInputAlaniYazildi(this.id),SagVeSolBosluklariSIl(this.id)" oninput="MetinInputAlaniYazildi(this.id)" required="" class="FormAlanlariUcunTextInputlari" maxlength="2" tabindex="5" onKeyUp="AzerbaycanHerfleriniIngilisHerflereDeyisdir(this.id),IngilizceyeGoreKucukHarfBuyukHarfDegistir(this.id)">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="SeyfeIciSetirAlaniKapsayici">
				<div class="SeyfeIciSetirAlaniKapsayiciYuzdeEllilikAlan">
					...
					<div class="SeyfeIciSetirAlanlariSagFormElementleriAlaniKapsayicisi">
						<div class="YuzPixselSinirliAlanKapsayicisi">
							<input type="text" id="ISO_KODU_ALFA_3" name="ISO_KODU_ALFA_3" value="<?php echo $dovletcek['ISO_KODU_ALFA_3']?>"  onfocusout="MetinInputAlaniYazildi(this.id),SagVeSolBosluklariSIl(this.id)" oninput="MetinInputAlaniYazildi(this.id)" required="" class="FormAlanlariUcunTextInputlari" maxlength="3" tabindex="6" onKeyUp="AzerbaycanHerfleriniIngilisHerflereDeyisdir(this.id),IngilizceyeGoreKucukHarfBuyukHarfDegistir(this.id)">
			...
			<div class="SeyfeIciSetirAlaniKapsayici">
				<div class="SeyfeIciSetirAlaniKapsayiciYuzdeEllilikAlan">
					...
					<div class="SeyfeIciSetirAlanlariSagFormElementleriAlaniKapsayicisi">
						<div class="YuzPixselSinirliAlanKapsayicisi">						
							<input type = "number" class=" FormAlanlariUcunTextInputlari number" value="<?php echo $dovletcek['Dovlet_Reqem_Kodu']?>" min="0"  max="999" 
							oninput="ReqemInputAlaniYazildi(this.id)" onkeypress="return event.keyCode === 8 || event.charCode >= 48 && event.charCode <= 57" onfocusout="ReqemInputAlaniYazildi(this.id)" tabindex="7" maxlength = "3"  id="Dovlet_Reqem_Kodu" required=""  name="Dovlet_Reqem_Kodu"/>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="SeyfeIciSetirAlaniKapsayici">
				<div class="SeyfeIciSetirAlaniKapsayiciYuzdeEllilikAlan">
					...
					<div class="SeyfeIciSetirAlanlariSagFormElementleriAlaniKapsayicisi">
						<div class="YuzPixselSinirliAlanKapsayicisi">	
							<input type = "number" class=" FormAlanlariUcunTextInputlari number" value="<?php echo $dovletcek['Dovlet_Musteqillik_Tarixi']?>" min="0"  max="9999" 
							oninput="ReqemInputAlaniYazildi(this.id)" onkeypress="return event.keyCode === 8 || event.charCode >= 48 && event.charCode <= 57" onfocusout="ReqemInputAlaniYazildi(this.id)" maxlength = "4" tabindex="8" id="Dovlet_Musteqillik_Tarixi" required=""  name="Dovlet_Musteqillik_Tarixi"/>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="SeyfeIciSetirAlaniKapsayici">
				<div class="SeyfeIciSetirAlaniKapsayiciYuzdeEllilikAlan">
					...
					<div class="SeyfeIciSetirAlanlariSagFormElementleriAlaniKapsayicisi">
						<div class="YuzPixselSinirliAlanKapsayicisi">
							<input type = "number" class=" FormAlanlariUcunTextInputlari number" value="<?php echo $dovletcek['Dovlet_Telefon_Kodu']?>" min="0"  max="9999" 
							oninput="ReqemInputAlaniYazildi(this.id)" onkeypress="return event.keyCode === 8 || event.charCode >= 48 && event.charCode <= 57" onfocusout="ReqemInputAlaniYazildi(this.id)" maxlength = "5" tabindex="9"  id="Dovlet_Telefon_Kodu" required=""  name="Dovlet_Telefon_Kodu"/>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="SeyfeIciSetirAlaniKapsayici">
				<div class="SeyfeIciSetirAlaniKapsayiciYuzdeEllilikAlan">
					...
					<div class="SeyfeIciSetirAlanlariSagFormElementleriAlaniKapsayicisi">
						<div class="YuzPixselSinirliAlanKapsayicisi">
							<input type = "text" class=" FormAlanlariUcunTextInputlari number" value="<?php echo $dovletcek['Dovlet_Valyuta_Kodu']?>" 
							oninput="MetinInputAlaniYazildi(this.id)"  onfocusout="MetinInputAlaniYazildi(this.id),SagVeSolBosluklariSIl(this.id)" maxlength = "3"  id="Dovlet_Valyuta_Kodu" onKeyUp="AzerbaycanHerfleriniIngilisHerflereDeyisdir(this.id),IngilizceyeGoreKucukHarfBuyukHarfDegistir(this.id)" required=""tabindex="10" name="Dovlet_Valyuta_Kodu"/>
						</div>
					</div>
				</div>
			</div>
		</div>
		<input type="hidden" name="Dovletyenile" value="Dovletyenile">
		<input type="hidden" name="Dovlet_Id" value="<?php echo $dovletcek['Dovlet_Id']?>" >

		<div class="SayfaIciButonlarIcinSatirAlanlariKapsayicisi">
			<button type="button" class="YenileButonlari" tabindex="11" name="UmumiAyarlarYenile" onClick="DovletIslemleriFormKontrol()">Yenilə</button>
			<button type="button" class="QirmiziButonlar" tabindex="12" onclick="Geri()" >İmtina Et</button>
		</div>
	</form>
</div>
</section>
