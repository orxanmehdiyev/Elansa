...
<div id="ListelemeAlaniKapsayicisi">   
  ...
  $elansor=$db->prepare("SELECT * FROM elan where yayim_durumu=:yayim_durumu and VIP=:VIP order by $siralama LIMIT $SayfalamayaBaslanacakKayitSayisi, $YeniElanlarListelemeLimiti");
