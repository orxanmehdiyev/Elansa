...
function elanyerlesdirkontrol() {
	...
	if (document.getElementById('emlakin_veziyyeti')) {
		var MenzilElanNovuSecimKontrol = document.getElementById('emlakin_veziyyeti');
		if (MenzilElanNovuSecimKontrol.value == "") {
			document.getElementById('emlakin_veziyyeti_secilmedi').style.display = 'block';
			document.getElementById('emlakin_veziyyetilabel').style.color = '#ff0000';
			document.getElementById('emlakin_veziyyeti').style.color = '#ff0000';
			document.getElementById("emlakin_veziyyeti").style.borderColor = "#ff0000";
			document.getElementById("emlakin_veziyyeti").style.boxShadow = " 1px 0px 1px 0px #ff0000";
			MenzilElanNovuSecimKontrol.focus();
			return;
		}
	}
	...
	if (document.getElementById('avto_model')) {
		var AvtoModelSecimKontrol = document.getElementById('avto_model');
		if (AvtoModelSecimKontrol.value == "") {
			document.getElementById('avtomodelsecilmedi').style.display = 'block';
			document.getElementById('avtomodelid').style.color = 'red';
			document.getElementById('avto_model').style.color = 'red';
			document.getElementById("avto_model").style.borderColor = "red";
			document.getElementById("avto_model").style.boxShadow = " 1px 0px 1px 0px #ff0000";
	...
	if (document.getElementById('yanacaq_id')) {
		var AvtoYanacaqSecimKontrol = document.getElementById('yanacaq_id');
		if (AvtoYanacaqSecimKontrol.value == "") {
			document.getElementById('avtoyanacaqnovusecilmedi').style.display = 'block';
			document.getElementById('avtoyanacaqlabel').style.color = 'red';
			document.getElementById('yanacaq_id').style.color = 'red';
			document.getElementById("yanacaq_id").style.borderColor = "red";
			document.getElementById("yanacaq_id").style.boxShadow = " 1px 0px 1px 0px #ff0000";
	...
	if (document.getElementById('avtomobil_ban_novu_id')) {
		...
		if (AvtoBanNovuSecimKontrol.value == "") {
			document.getElementById('AvtoBanNovuSecilmedi').style.display = 'block';
			document.getElementById('avtobanlabel').style.color = '#ff0000';
	...
	if (document.getElementById('avto_suret_qutusu_id')) {
		...
		if (AvtoSuretQutusuSecimKontrol.value == "") {
			document.getElementById('AvtoSuretQutusuSecilmedi').style.display = 'block';
			document.getElementById('AutoSuretQutusuLabel').style.color = '#ff0000';
	...
	if (document.getElementById('yurus_km')) {
		var AvtoYusrusKmKontrol = document.getElementById('yurus_km');
		if (AvtoYusrusKmKontrol.value == "") {
			document.getElementById('AvtoYusurKmSecilmedi').style.display = 'block';
			document.getElementById('AvtoYurusKmLabel').style.color = '#ff0000';
			document.getElementById('yurus_km').style.color = '#ff0000';
			document.getElementById("yurus_km").style.borderColor = "#ff0000";
			document.getElementById("yurus_km").style.boxShadow = " 1px 0px 1px 0px #ff0000";
			AvtoYusrusKmKontrol.focus();
			return;
		}
	}
	...
	if (document.getElementById('buraxilis_ili')) {
		var AvtoBuraxilisIliKontrol = document.getElementById('buraxilis_ili');
		if (AvtoBuraxilisIliKontrol.value == "") {
			document.getElementById('AvtoBuraxilisIliSecilmedi').style.display = 'block';
			document.getElementById('AvtoBuraxilisIliLabel').style.color = '#ff0000';
			document.getElementById('buraxilis_ili').style.color = '#ff0000';
			document.getElementById("buraxilis_ili").style.borderColor = "#ff0000";
			document.getElementById("buraxilis_ili").style.boxShadow = " 1px 0px 1px 0px #ff0000";
