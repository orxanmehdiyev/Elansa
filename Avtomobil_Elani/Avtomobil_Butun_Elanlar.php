<div class="tab-content" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" id="pills-bir-tab" data-toggle="pill" href="#pills-bir" role="tab" aria-controls="pills-bir" aria-selected="true">Bugün <i class="bi bi-calendar2-check"></i></a>
      </li>
      <li class="nav-item">
        ...
        baxılan <i class="bi bi-exclude"></i></a>
      </li>
      <li class="nav-item">
        ...
        qiymət <i class="bi bi-arrow-down"></i></a>
      </li>
      <li class="nav-item">
        ...
        qiymət <i class="bi bi-arrow-up"></i></a>
      </li>
    </ul>
    <select class="form-select" id="tab_selector">
    ...
    <div class="tab-pane fade show active" id="pills-birs" role="tabpanel" aria-labelledby="pills-birs-tab">
      <div class="row">
        ...
        while ($neqliyyatcek = $neqliyyatsor->fetch(PDO::FETCH_ASSOC)) {
          ...
          <div class="col-6">
                            <!--a class="iki-tab"
                            href="elandetay-<?= $neqliyyatcek["SEO_URL"] . '-' . $neqliyyatcek["elan_id"] ?>"" title="">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="card-image-overlay">
                                        ...
                                        /
                                        <span
                                            class="card-detail-badge"><?php echo $neqliyyatcek['avtomobilmuherrikhecmi_ad'] ?>
                                            sm<sup>3</sup></span> /
                                ...
                                <li>
                                    <div class="card-body text-center">
                                        ...
                                        <button
                                            class="btn"><?php echo number_format($neqliyyatcek['qiymet'], 2, ',', '.') . " " . $neqliyyatcek['pul_novu'] ?></button>
                                    </div>
                                </li>
                            </ul>
                        </div>
...
<script type="text/javascript">
      ...
      $('.nav-pills li a').eq($(this).val()).pill('show');
  });
    </script> 