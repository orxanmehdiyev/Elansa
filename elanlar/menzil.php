		...
		<a href="elandetay-<?= $elancek["SEO_URL"] . '-' . $elancek["elan_id"] ?>" title="">
			<div class="card" >
				...
				<div class="card-image-overlay  ">
					<span class="card-detail-badge"><i class="fas fa-couch"></i><?php echo $elancek['otaq_sayi']?> otaqlı</span>/
					<span class="card-detail-badge"><i class="texture"></i><?php echo $elancek['umumi_sahesi']?> m<sup>3</sup></span>/
					<span class="card-detail-badge"><i class="fas fa-layer-group"></i><?php echo $elancek['binaninmertebesayi']?>/<?php echo $elancek['yerlesdiyi_mertebe']?> mərtəbə</span>
