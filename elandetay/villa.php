	...
	<div class="in-bread">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="villahamisi">Villa/Bağ Evləri</a></li>
	...
	<div class="row">
		<div class="col-9">
			<div class="inner-code">
				<div class="row">
					<div class="col-9">
						<h3><?php echo $elandetaycek['elan_adi']?>dd</h3>
					...
					<div class="col-3">
						<ul class="car-info">
							...
							<li><span>Mərtəbə</span> <?php echo $elandetaycek['binaninmertebesayi']?></li>
							<li><span>Ümumi Sahəsi</span><?php echo $elandetaycek['umumi_sahesi']?> m<sup>2</sup></li>
							<li><span>Yaşayış Sahəsi</span><?php echo $elandetaycek['yasayis_sahesi']?> m<sup>2</sup></li>
						...
						<div class="col-6">
							<table class="table table-striped">
								<tbody>
									...
									<tr> 
										<td>Yaşayış Sahəsi</td>
										<td><?php echo $elandetaycek['yasayis_sahesi']?>  m<sup>2</sup></td>
									</tr>	
									<tr> 
										<td>Proyekt</td>
