	...
	<div class="in-bread">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="menzilhamisi">Mənzil</a></li>
		...
		<div class="col-9">
			...
			<div class="col-3">
				<ul class="car-info">
					...
					<li><span>Otaq Sayı</span> <?php echo $elandetaycek['otaq_sayi'] ?></li>
					<li><span>Binanın Tipi</span> <?php echo $elandetaycek['binatipi_adi'] ?></li>
					<li><span>Yerləşdiyi Mərtəbə</span> <?php echo $elandetaycek['yerlesdiyi_mertebe']?></li>
				...
				<div class="col-6">
					<table class="table table-striped">
						<tbody>
							<tr> 
								<td>Bina Tipi</td>
								<td><?php echo $elandetaycek['binatipi_adi'] ?></td>
							</tr>
							<tr> 
								<td>Təmir Tipi</td>
							...
							<tr> 
								<td>Binanın Mərtəbə Sayı</td>
								<td><?php echo $elandetaycek['binaninmertebesayi'] ?></td>
							</tr>		
							<tr> 
								<td>Yerləşdiyi Mərtəbə</td>
								<td><?php echo $elandetaycek['yerlesdiyi_mertebe'] ?></td>
							</tr>	
							<tr> 
								<td>Proyekt</td>
								<td><?php echo $elandetaycek['proyekt_ad'] ?> </td>
							</tr>	
							<tr> 
								<td>Krediti</td>
				...
				<div class="col-6">
					<table class="table table-striped">
						<tbody>
							...
							<tr> 
								<td>Yerləşdiyi Blok</td>
								<td><?php echo $elandetaycek['yerlesdiyiblok_ad'] ?></td>
							</tr>
							<tr> 
								<td>Otaq Sayı</td>
								<td><?php echo $elandetaycek['otaq_sayi'] ?></td>
							</tr>
							<tr> 
								<td> Ümumi Sahəsi </td>
